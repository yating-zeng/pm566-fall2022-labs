...
We can use count() from dplyr to figure out how many records are there per specialties?

different catagories do we have? Are these catagories related? overlapping? evenly distributed?

```{r medical_specialties}
specialties <- 
    mts %>%
...
```{r barplot-of-specialties-counts}
specialties %>%
  top_n(10) %>%
...
After removing stop words, it gives us a better idea of what the text is about.
