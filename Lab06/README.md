...
![](README_files/figure-gfm/barplot-of-specialties-counts-1.png)<!-- -->
...
There are lots of stop words here, non-specific to medical text.
...
After removing stop words, it gives us a better idea of what the text is
about.
